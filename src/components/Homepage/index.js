...
export default function ContainedButtons() {
  ...
  return (
    ...
    <div className={classes.root}>
      ...
      <Button variant="contained" color="primary" href="#contained-buttons" onClick={() => window.open('https://www.linkedin.com/in/jessica-anocibar-b9b129127/')}>
        LinkedIn
      </Button>
      <Button variant="contained" color="primary" href="#contained-buttons" onClick={() => window.open('https://github.com/jessicaano92')}>
        GitHub
      </Button>
    </div>
    </>
